...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	/* VL: Follow variables moved inside adventurerCard for refactoring
	// int drawntreasure=0; 
	// int cardDrawn;	  
	...
	*/
	...
	switch( card ) 
	{
		...
		case steward:
			return stewardCard(state, choice1, choice2, choice3, handPos);
...
/***********************************************************************************************
 * Assignment 2 Refactor functions
 * Refactored: Pick 5 cards implemented in dominion.c and implement them in seperate functions,
